...
const mentorsData = [
  ...
  },
  {
    ...
    "yearOfExperience": 7,
    "expertiseTags": ["Higher Education", "SOP Review", "PhD Admissions", "Scholarships"],
  ...
  },
  {
    ...
    "yearOfExperience": 8,
    "expertiseTags": ["Civil Engineering", "ETABS", "AutoCAD", "BIM", "Structural Analysis"],
  ...
  },
  {
    ...
    "yearOfExperience": 6,
    "expertiseTags": ["Corporate Law", "Contracts", "IP Protection", "Startup Compliance"],
  ...
  },
  {
    ...
    "yearOfExperience": 9,
    "expertiseTags": ["UI/UX Design", "Figma", "Design Systems", "User Research", "Wireframing"],
    ...
    for (const item of mentorsData) {
      ...
      await prisma.mentor.upsert({
        ...
        create: {
          ...
          verificationStatus: "APPROVED",
          resume: "https://res.cloudinary.com/demo/image/upload/sample_resume.pdf",
          documents: [
            {
              title: "Identity / Certificate",
              fileUrl: "https://res.cloudinary.com/demo/image/upload/sample_certificate.pdf",
